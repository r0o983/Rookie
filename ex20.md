...
使![img](assets/lu34114ue_tmp_5bd7b81806920539.png) 用seek()来重新定位IO流指针的位置,参数为偏移量,默认偏移量为0

Use seek()to reposition the position of the IO stream pointer the parameter is the offset and the default offset is 0

![image-20200403213243121](assets/image-20200403213243121.png)
...
![image-20200403213600397](assets/image-20200403213600397.png)
...
![image-20200403213804139](assets/image-20200403213804139.png)
...
结果:
![image-20200403213944905](assets/image-20200403213944905.png)
...
![image-20200403214048643](assets/image-20200403214048643.png)
